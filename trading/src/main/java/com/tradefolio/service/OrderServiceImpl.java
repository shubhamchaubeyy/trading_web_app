...
import com.tradefolio.domain.OrderStatus;
...
import com.tradefolio.repository.OrderItemRepository;
import com.tradefolio.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
	...
	public Order sellAsset(Coin coin ,double quantity,User user) throws Exception {
		...
		double buyPrice =assetToSell.getBuyPrrice();
		...
		else throw new Exception("asset not found");
	}
